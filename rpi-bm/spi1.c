 ...
 *
 *  Use to temporarity set CS to high (for SD card init).
 *  Only CS2, header P1 pin 36.
 *
 * param:  None
 * return: None
 *
 */
void bcm2835_spi1_set_cs_high(void)
{
    bcm2835_gpio_fsel(RPI_V2_GPIO_P1_36, BCM2835_GPIO_FSEL_OUTP);
    bcm2835_gpio_set(RPI_V2_GPIO_P1_36);    // CS to 'High'
}

/*------------------------------------------------
 * bcm2835_spi1_set_cs_spi_func()
 *
 *  Use to temporarity return CS to notmal operation (for SD card init).
 *  Only CS2, header P1 pin 36
 *
 * param:  None
 * return: None
 *
 */
void bcm2835_spi1_set_cs_spi_func(void)
{
    bcm2835_gpio_fsel(RPI_V2_GPIO_P1_36, BCM2835_GPIO_FSEL_ALT4);
}
